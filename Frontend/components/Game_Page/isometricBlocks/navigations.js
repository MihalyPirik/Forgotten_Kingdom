    ...
    if (direction == 'x') {
        ...
        if (backwardButton.value == 'undefined') {
            ...
            forwardButton.addEventListener('click', () => {
                console.log(game.isometricBlocks[game.currentBlockX][nextY])
            })
        }
        if (forwardButton.value == 'undefined') {
            ...
            backwardButton.addEventListener('click', () => {
                console.log(game.isometricBlocks[game.currentBlockX][previousY])
            })
        }
    }
    if (direction == 'y') {
        ...
        if (backwardButton.value == 'undefined') {
            ...
            backwardButton.addEventListener('click', () => {
                console.log(game.isometricBlocks[previousX][game.currentBlockY])
            })
        }
        if (forwardButton.value == 'undefined') {
            forwardButton.remove()
            ...
            forwardButton.addEventListener('click', () => {
                console.log(game.isometricBlocks[nextX][game.currentBlockY])
            })
        }
    }
}
