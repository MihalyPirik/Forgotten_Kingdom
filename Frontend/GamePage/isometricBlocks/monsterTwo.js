...
export const Szörny2=(game)=>{
    game.currentBlock=new IsometricBlock(
        ...
        [
            new Panel('navigationX','navigationPanel',game.width*0.7638,game.height*0.7574,game.width*0.2,{forwardId:'forward',backwardId:'backward',direction:'x'}),
        new Panel('navigationY','navigationPanel',game.width*0.2425,game.height*0.7713,game.width*0.2,{forwardId:'forward',backwardId:'backward',direction:'y'})
        ]
